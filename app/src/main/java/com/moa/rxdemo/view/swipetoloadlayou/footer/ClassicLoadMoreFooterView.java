package com.moa.rxdemo.view.swipetoloadlayou.footer;
...
import com.moa.rxdemo.view.swipetoloadlayou.SwipeLoadMoreFooterLayout;
...
public class ClassicLoadMoreFooterView extends SwipeLoadMoreFooterLayout {
    ...
    public ClassicLoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFooterHeight = getResources().getDimensionPixelOffset(R.dimen.swipe_load_more_footer_height);
    }
