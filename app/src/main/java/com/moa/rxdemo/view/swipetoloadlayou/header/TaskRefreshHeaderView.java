package com.moa.rxdemo.view.swipetoloadlayou.header;
...
import com.moa.rxdemo.view.swipetoloadlayou.SwipeRefreshHeaderLayout;
...
public class TaskRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    protected void onFinishInflate() {
        ...
        tvRefresh.setText(R.string.swipe_onload_data_hint);
    }
    ...
    public void complete() {
        tvRefresh.setText(R.string.swipe_refresh_complete);
    }
