    ...
    public static ResponeException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            switch (httpException.code()) {
                ...
                default:
                    ex.message = context.getString(R.string.error_net);
                    break;
            }
            return ex;
        }
            ...
            ex.message = context.getString(R.string.error_parse);
            return ex;
        }
            ...
            ex.message = context.getString(R.string.error_ssl);
            return ex;
        }
        else if (e instanceof IllegalArgumentException) {
            ex = new ResponeException(e, Error.DATA_ERROR);
            ex.message = context.getString(R.string.error_data_error);
            return ex;
        }
        else {
            ex = new ResponeException(e, Error.UNKNOWN);
            ex.message = context.getString(R.string.error_unknow);
            return ex;
        }
    }
