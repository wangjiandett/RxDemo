...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        BaseApp.getAppContext().startActivity(
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) BaseApp.getAppContext().getSystemService(
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) BaseApp.getAppContext().getSystemService(
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) BaseApp.getAppContext().getApplicationContext().getSystemService(
