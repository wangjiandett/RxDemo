...
public interface IComponentLifeCycle extends ComponentCallbacks2 {
    ...
    /**
     * 表示组件的优先级，组件初始化时以该方法的返回值进行排序优先级越高的越先进行初始化，
     *
     ...
     *
     * @return {@link ComponentPriority#LEVEL_HIGH}<br/>
     *         {@link ComponentPriority#LEVEL_MID}<br/>
     *         {@link ComponentPriority#LEVEL_LOW}<br/>
     */
    int level();
